...
// Fetch all committee images
$sql = "SELECT image_path FROM emergency_contacts ORDER BY uploaded_at DESC";
...
<div id="main-content" class="p-8">
  ...
  <div class="flex items-center justify-between mb-6">
    <h1 class="text-3xl font-bold text-white">Official Committees</h1>
  </div>
    ...
    <?php if (!empty($images)): ?>
      <div class="space-y-8">
        <?php foreach ($images as $imagePath): ?>
          <div class="w-full">
            <img src="../admin/emergency_contacts/<?php echo basename($imagePath); ?>" 
                 alt="Committee Image"

...
<div class="fixed top-0 left-0 w-64 h-screen bg-primary text-white flex flex-col py-10 px-6 shadow-2xl z-50">
  ...
  <nav class="flex-1 space-y-2 text-sm">
    ...
    <a href="announcements.php" class="flex items-center px-4 py-3 rounded-lg <?php echo ($current_page == 'announcements.php') ? 'bg-white text-primary font-semibold shadow' : 'hover:bg-white hover:text-primary hover:font-semibold'; ?> transition">
      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="registered_residents.php" class="flex items-center px-4 py-3 rounded-lg <?php echo ($current_page == 'registered_residents.php') ? 'bg-white text-primary font-semibold shadow' : 'hover:bg-white hover:text-primary hover:font-semibold'; ?> transition">
      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M12 4v16m8-8H4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
     Registered Residents Lists
    </a>

     <a href="emergency_contacts.php" class="flex items-center px-4 py-3 rounded-lg <?php echo ($current_page == 'emergency_contacts.php') ? 'bg-white text-primary font-semibold shadow' : 'hover:bg-white hover:text-primary hover:font-semibold'; ?> transition">
      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path d="M12 4v16m8-8H4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
     Emergency Contacts
